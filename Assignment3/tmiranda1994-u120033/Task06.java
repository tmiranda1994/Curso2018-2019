...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		janeSmith.addLiteral(VCARD.FN, "Jane Smith"); // should I "addLiteral" or "addProperty"?
		janeSmith.addLiteral(VCARD.Given, "Jane");    // should I "addLiteral" or "addProperty"?
		janeSmith.addLiteral(VCARD.Family, "Smith");  // should I "addLiteral" or "addProperty"?
